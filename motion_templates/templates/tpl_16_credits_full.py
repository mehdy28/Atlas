"""Credits Roll - "full" template (A->B->C)

Category: credits  |  Family: credits
...
from st_16_credits_a import state as state_a
from st_16_credits_b import state as state_b
from st_16_credits_c import state as state_c

META = {
    'id': 'tpl_16_credits_full',
    'category': 'credits',
    'family': 'credits',
    'states_used': ['st_16a', 'st_16b', 'st_16c'],
    'duration_s': 7.80,
}
