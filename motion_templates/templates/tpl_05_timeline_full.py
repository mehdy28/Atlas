"""Timeline / Sequence of Events - "full" template (A->B->C)

Category: timeline  |  Family: timeline
...
from st_05_timeline_a import state as state_a
from st_05_timeline_b import state as state_b
from st_05_timeline_c import state as state_c

META = {
    'id': 'tpl_05_timeline_full',
    'category': 'timeline',
    'family': 'timeline',
    'states_used': ['st_05a', 'st_05b', 'st_05c'],
    'duration_s': 7.80,
}
