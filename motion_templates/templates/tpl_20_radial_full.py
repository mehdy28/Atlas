"""APPROVAL - "full" template (A->B->C)

Category: radial  |  Family: radial
...
from st_20_radial_a import state as state_a
from st_20_radial_b import state as state_b
from st_20_radial_c import state as state_c

META = {
    'id': 'tpl_20_radial_full',
    'category': 'radial',
    'family': 'radial',
    'states_used': ['st_20a', 'st_20b', 'st_20c'],
    'duration_s': 7.80,
}
