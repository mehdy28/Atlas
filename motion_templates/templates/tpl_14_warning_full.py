"""Warning / Alert Card - "full" template (A->B->C)

Category: warning  |  Family: warning
...
from st_14_warning_a import state as state_a
from st_14_warning_b import state as state_b
from st_14_warning_c import state as state_c

META = {
    'id': 'tpl_14_warning_full',
    'category': 'warning',
    'family': 'warning',
    'states_used': ['st_14a', 'st_14b', 'st_14c'],
    'duration_s': 7.80,
}
