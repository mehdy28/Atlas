"""Title / Section Header - "full" template (A->B->C)

Category: title  |  Family: banner
...
from st_01_title_a import state as state_a
from st_01_title_b import state as state_b
from st_01_title_c import state as state_c

META = {
    'id': 'tpl_01_title_full',
    'category': 'title',
    'family': 'banner',
    'states_used': ['st_01a', 'st_01b', 'st_01c'],
    'duration_s': 7.80,
}
