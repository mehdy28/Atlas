"""Definition / Glossary Card - "full" template (A->B->C)

Category: definition  |  Family: definition
...
from st_13_definition_a import state as state_a
from st_13_definition_b import state as state_b
from st_13_definition_c import state as state_c

META = {
    'id': 'tpl_13_definition_full',
    'category': 'definition',
    'family': 'definition',
    'states_used': ['st_13a', 'st_13b', 'st_13c'],
    'duration_s': 7.80,
}
